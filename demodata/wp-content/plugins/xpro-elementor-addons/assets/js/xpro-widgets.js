!(function(e, t) {
    ...
    let i = {
        ...
        SimplePortfolio: function(t) {
            ...
            function m() {
                "1" === o.popup_animation && c.to(t.find(".xpro-portfolio-loader-style-1 li"), {
                        duration: 0.4,
                        scaleX: 1,
                        transformOrigin: "bottom right"
                    }),
                    "2" === o.popup_animation && c.to(t.find(".xpro-portfolio-loader-style-2 li"), {
                        duration: 0.4,
                        scaleX: 1,
                ...
                if (
                    (o.recaptcha && (a = t.find(".g-recaptcha-response").val()),
                        e.each(s, function(e, i) {
                            "" !== i.value && "g-recaptcha-response" !== i.name && ((p[u] = {
                                name: t.find("label[for=" + i.name.replaceAll("[]", "") + "]").text() || "",
                                value: i.value
                            }), u++);
                        }),
                ...
                t.find(".xpro-contact-form-message").slideUp(),
                    e.ajax({
                        ...
                        data: {
                            ...
                            formName: o.form_name,
                            formSubject: o.form_subject,
                            captcha: a
                        }
                    }).done(function(e) {
                        e.success ?
