        ...
        h = function(e, t, n) {
            ...
            v.initialize = function() {
                v.logError = r.withModule(s), i(function() {
                    t = t || e.document.body, v.establishPreconnections(), v.observe(), v.collectWidgets(t), v.boot(), v.watchWidgetReset()
                })
            }, v.establishPreconnections = function() {
                v.preconnect(v.getPlatformUrl()), v.preconnect("https://static.elfsight.com"), v.preconnect("https://service-reviews-ultimate.elfsight.com"), v.preconnect("https://storage.elfsight.com")
